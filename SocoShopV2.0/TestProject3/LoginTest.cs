...
namespace TestProject3
{
    ...
    public class LoginTest
    {
        ...
        public void checkloginTest()
        {
            ...
            string logname = "1631320229"; // TODO: 初始化为适当的值
            string loginpass = "zxcvbnm1"; // TODO: 初始化为适当的值
        ...
        {
            Login_Accessor target = new Login_Accessor(); // TODO: 初始化为适当的值
            //string logname = string.Empty;//TODO:初始化为适当值
            //string loginpass = string.Empty;//TODO:初始化为适当值
            target.PageLoad();
            Assert.Inconclusive("无法验证不返回值的方法。");
        }
